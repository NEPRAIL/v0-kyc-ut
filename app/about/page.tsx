        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {teamMembers.map((member, index) => (
            <Card key={index} className="text-center bg-card border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                <div className="w-32 h-32 bg-gradient-to-r from-primary to-secondary rounded-full mx-auto mb-6 flex items-center justify-center overflow-hidden">
                  <img
                ...
                <Badge className="bg-secondary/10 text-secondary border-secondary/20 mb-4">{member.role}</Badge>
