...
async function lazyImportAuth() {
  try {
    return await import("@/lib/security")
  } catch {}
  try {
    return await import("@/lib/auth-server")
  } catch {}
  try {
    return await import("@/lib/auth/middleware")
  } catch {}
  return null
}
...
export async function GET(req: NextRequest) {
  ...
  const verifySession = (auth as any).verifySession || (auth as any).requireAuth || (auth as any).getSession || null
